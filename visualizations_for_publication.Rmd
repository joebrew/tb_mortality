...
x$`% difference (IHME / WHO)` <- paste0(round(x$IHME / x$WHO * 100, digits = 2), '%')

x$`% difference (WHO / IHME)` <- paste0(round(x$WHO / x$IHME * 100, digits = 2), '%')
...
# Table on the different methods used by WHO and IHME
